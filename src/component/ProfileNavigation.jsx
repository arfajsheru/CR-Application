...
const ProfileNavigation = () => {
  const options = [
    ...
    { title: "Suggest Products", icon: require("../assets/suggestproduct.png"), name:"SuggestProducts" },
  ];
  ...
  return (
    <View style={styles.container}>
      {options.map((item, index) => (
        <TouchableOpacity key={index} style={styles.navContainer} activeOpacity={1} onPress={() => navigation.navigate(item.name)}>
